// ==========================================
// Shader: Voronoi Cell Noise Visualizer
// Category: Noise 
// Description: Generates a Voronoi cell-based noise pattern with optional distortion for organic appearance.
// Screenshot: screenshots/noise/voronoi cell.png
// ==========================================
